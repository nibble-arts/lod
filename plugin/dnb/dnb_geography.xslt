...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
	...
	<xsl:template match="gnd:record">
		<tr>
			<td><xsl:value-of select="descendant-or-self::gndo:preferredNameForThePlaceOrGeographicName"/></td>
			<td><xsl:value-of select="descendant-or-self::gndo:Definition"/></td>
			<td><xsl:apply-templates select="descendant-or-self::gndo:variantNameForThePlaceOrGeographicName"/></td>
			<td>
				<a target="_blank">
	...
	<xsl:template match="gndo:variantNameForThePlaceOrGeographicName">
